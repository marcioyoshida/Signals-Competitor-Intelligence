...
SEGMENTS: tuple[Segment, ...] = (
    ...
    Segment("CVM", "fundos", "Fundos de investimento (FI/FIDC/FIP/ETF)",
            ...
            note="cvm_fundos registrant list is the roster"),
    ...
    Segment("CVM", "securitizadoras", "Securitizadoras / companhias securitizadoras",
            ("financial-data-analytics",),
            ("ofertas", "news"), entity_sync=None,
            note="no dedicated source -> #14 (segment maps loosely)"),
