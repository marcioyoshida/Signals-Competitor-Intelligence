...
OFFICERS: dict[str, Officer] = {
    "strategic": Officer(
        ...
        actions=("open_watch", "curate_belief", "trigger_run", "record_decision", "set_outcome", "set_board_adoption", "set_tdr_baseline", "append_reference", "record_engagement"),
    ),
    "regulator": Officer(
        role="regulator",
        ...
        actions=("open_watch", "trigger_run", "record_decision", "set_outcome", "set_board_adoption", "set_tdr_baseline", "append_reference", "record_engagement"),
    ),
    "compliance": Officer(
        role="compliance",
        ...
        actions=("run_integrity_audit", "flag_entity", "rollback_field", "revert_entity", "record_decision", "set_outcome", "set_board_adoption", "set_tdr_baseline", "append_reference", "record_engagement"),
    ),
    "product": Officer(
        role="product",
        ...
        actions=("resolve_review", "propose_vertical", "propose_registry_change", "record_decision", "set_outcome", "set_board_adoption", "set_tdr_baseline", "append_reference", "record_engagement"),
    ),
}
